      ...
      <div className="w-full">
        ...
        <div className="relative md:hidden mb-4 z-20">
          <button
            ...
            className="glass rounded-2xl px-4 h-12 flex items-center justify-between w-full border-none cursor-pointer"
          >
          ...
          {/* dropdown */}
          <div
            className="absolute top-[calc(100%+8px)] left-0 right-0 glass rounded-2xl py-2 overflow-hidden"
            style={{
        ...
        <div className="flex flex-col md:flex-row gap-4 items-start max-w-screen-2xl mx-auto">
          {/* ── Desktop sidebar ── */}
          <aside className="hidden md:block glass rounded-2xl p-2 w-48 shrink-0 sticky top-8 z-10">
